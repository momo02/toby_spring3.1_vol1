...
public class UserDaoTest {
	...
	public void setUp(){
		this.user1 = new User("gyumee","유저일","springno1",Level.BASIC,1,0,"user1@naver.com");
		this.user2 = new User("leegw700","유저이","springno2",Level.SILVER,55,10,"user2@naver.com");
		this.user3 = new User("bumjin","유저삼","springno3",Level.GOLD,100,40,"user3@naver.com");
	}
